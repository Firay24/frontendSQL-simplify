...
function Header({ importFileFunctionals }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const data = await importFileFunctionals(selectedFile);
  ...
  return (
    <div className="flex items-center justify-between">
      <Title title="Tambah Data" subheader="Data fungsional" />
      <div>
...
Header.propTypes = {
  importFileFunctionals: PropTypes.func.isRequired,
};
