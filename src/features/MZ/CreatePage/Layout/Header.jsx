...
function Header({ importFileBoard }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const data = await importFileBoard(selectedFile);
  ...
  return (
    <div className="flex items-center justify-between">
      <Title title="Tambah Data" subheader="Data MZ" />
      <div>
...
Header.propTypes = {
  importFileBoard: PropTypes.func.isRequired,
};
